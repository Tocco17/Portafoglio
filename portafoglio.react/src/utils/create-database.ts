...
const createDb = () => {
	...
	insertNewDataList(DatabaseKey.user, userDb)
	insertNewDataList(DatabaseKey.earningSuddivision, earningSuddivisionDb)
	insertNewDataList(DatabaseKey.earning, earningDb)
	insertNewDataList(DatabaseKey.label, labelDb)
	insertNewDataList(DatabaseKey.wallet, walletDb)
}
